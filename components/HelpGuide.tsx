...
const STEPS: { icon: string; title: string; body: string }[] = [
  ...
  {
    icon: "✅",
    title: "5. 測好了就「設為正式」＋設排程",
    body: "確認結果沒問題，按「設為正式」把它固定下來。想讓它自動跑，按「⏰ 排程」選「每季 / 每月 / 每週」和時間即可，不用懂任何程式。之後時間到就自動執行，產出的檔案在左邊「產出檔案」頁可直接拖到桌面。",
  },
  {
    icon: "🤖",
    title: "6. 正式流程排程跑失敗了怎麼辦？AI 已經先想好了",
    body: "設為正式的流程排程執行失敗時，桌面會跳通知，AI 也會在背景先想好怎麼修。你只要打開首頁，看到「AI 已經想好怎麼修」那條，按「✅ 套用並重跑」確認一下就好，不用自己找問題、也不用自己去點修復。",
  },
];
