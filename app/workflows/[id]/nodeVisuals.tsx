...
export const TYPE_META: Record<string, { cat: string; label: string }> = {
  ...
  "telegram-notify": { cat: "integration", label: "發 Telegram 通知" },
  "line-notify": { cat: "integration", label: "發 LINE 通知" },
  "set-variable": { cat: "logic", label: "設定變數" },
  "if-condition": { cat: "logic", label: "條件判斷" },
  "repeat-steps": { cat: "logic", label: "重複執行(對清單每一項)" },
  "llm-decide": { cat: "ai", label: "AI 判斷/產生" },
  "custom-code": { cat: "custom", label: "自訂步驟(AI 寫)" },
  ...
  "webmail-send": { cat: "browser", label: "用網頁信箱寄信" },
  "slack-notify": { cat: "integration", label: "發 Slack 通知" },
  ...
  "google-slides-refresh": { cat: "integration", label: "重新整理 Google 簡報圖表" },
